...
public class InputLanguageSelection extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        searchField.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                buildPreferenceList(s.toString());
            }
        });
    }

    private void buildPreferenceList(String query) {
        PreferenceGroup parent = getPreferenceScreen();
        parent.removeAll();
        String lowerQuery = query != null ? query.toString().toLowerCase(Locale.getDefault()) : "";
    ...
    protected void onPause() {
        ...
        // Maintain the order from mAvailableLanguages (which is now sorted)
        for (Loc loc : mAvailableLanguages) {
