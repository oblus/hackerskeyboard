...
## Performance & Context
- **Code Integrity**: Prioritiz e a complete, working solution over conciseness. You are allowed to rewrite entire methods if the current implementation is fundamentally broken.
